################################################################################################
# runs GTT emulation, plots performance
# To run execute do
# cmsRun L1Trigger/TrackerGTT/test/test.py
...
# load code that produces vertices
process.load( 'L1Trigger.TrackerGTT.Producer_cff' )
# load code that analyzes vertices
process.load( 'L1Trigger.TrackerGTT.Analyzer_cff' )

# build schedule
process.produce = cms.Path( process.ProducerVF )
process.analyze = cms.Path( process.AnalyzerVF )
